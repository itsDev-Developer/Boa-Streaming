...
## UI/UX + Ads Fixes (May 2026)

- Reworked Video.js ad lifecycle with clearer IMA initialization and debug logging (`adsready`, `adstart`, `adend`, `aderror`).
- Improved ad request timing for pre-roll/mid-roll/post-roll and recovery logic when ads fail.
- Enhanced download ad-gate flow with loading states, popup-block fallback, retry button, cooldown guard, and duplicate download prevention.
- Added advanced watch experience features: sharing (Web Share + copy + Telegram/WhatsApp/X), theater mode, skip intro, keyboard-ready controls via Video.js, progress/volume persistence.
- Updated homepage branding to **Uchiha Developer** and added CTA buttons:
  - Developer Contact: `https://t.me/Uchiha_Developer`
  - List Channels: `https://t.me/Uchiha_Community`
